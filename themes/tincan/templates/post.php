...
?>
    ...
    <ul class="post-controls" data-post="<?php echo $post->post_id; ?>">
      ...
      <?php } ?>
      <?php if (!empty($user)) { ?>
        <li class="reply"><a href="#" data-author="<?php echo $username; ?>" data-page="<?php echo $settings['page_thread']; ?>" data-thread="<?php echo $post->thread_id; ?>" data-threadpage="<?php echo $page_number; ?>" data-post="<?php echo $post->post_id; ?>">Reply</a></li>
      <?php } ?>
